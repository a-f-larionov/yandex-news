...
if (isset($_GET['month'])) {
    ...
    if ($month != 12) {
        ...
        $timeRightStr = "22." . (1) . ".2020";
    }
    $timeLeft = strtotime($timeLeftStr);
    $timeRight = strtotime($timeRightStr);
...
while ($row = $result->fetch_assoc()) {
    if (!isset($authorGroups[$row['author']])) {
        $authorGroups[$row['author']] = 0;
    }
