        ...
        //var host = 'http://alor.8ffd246e-5d74-49a5-8696-e92eff606a60.pub.cloud.scaleway.com/';
        var host = 'http://local.host/';
        ...
        if (location.href.search('newssearch.yandex.ru') != -1) {
            yandexStep1ParseData();
        }
